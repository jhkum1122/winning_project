...
public class BoardDAO {
	...
	public int insertArticle(BoardInfo article){
		...
		try{
			...
			System.out.println("현재 작성된 글의 갯수"+rs.getInt(1));
			System.out.println("NO = board_numer : "+article.getB_num());
			System.out.println("DB's b_num "+article.getB_num());
			System.out.println("20190306 record number ref = " + ref 
					+ ",re_step = " + re_step
					+ ",re_level = " + re_level
					+ ",b_number = "
					+ article.getB_num());
